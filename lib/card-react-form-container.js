(function() {
  ...
  CardReactFormContainer = createReactClass({
        ...
        return function(child) {
          ...
          if (child.props && child.props.name) {
            ...
            return React.cloneElement(child, {
              ...
              error: newClassName && newClassName.includes(_this.props.classes.invalid),
    ...
    getInput: function(inputName) {
      return ReactDOM.findDOMNode(this.refs[this.inputsRefs[inputName]]);
    },
    isValid: function(inputName, inputValue) {
      var currentInputsValidationClass, inputsNames, objVal;
      inputsNames = this.props.formInputsNames;
      currentInputsValidationClass = this.state.inputsValidationClass;
      switch (inputName) {
        ...
        case inputsNames["cvc"]:
          return Payment.fns.validateCardCVC(inputValue, this.cardType);
        case inputsNames["number"]:
